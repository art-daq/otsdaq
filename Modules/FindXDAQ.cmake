...
if(XDAQ_FOUND)
  ...
  if (NOT TARGET XDAQ::xdaq)
    ...
    set_target_properties(XDAQ::xdaq PROPERTIES INTERFACE_INCLUDE_DIRECTORIES "${XDAQ_INCLUDE_DIRS}" IMPORTED_NO_SONAME TRUE IMPORTED_LOCATION "${XDAQ_XDAQ_LIBRARY}")
  endif()
