#ifndef _TFMSupervisor_version_h_
#define _TFMSupervisor_version_h_
...
namespace TFMSupervisor
{
const std::string project  = "otsdaq";
const std::string package  = "TFMSupervisor";
const std::string versions = MYPACKAGE_FULL_VERSION_LIST;
const std::string summary  = "TFMSupervisor otsdaq supervisor base class";
const std::string description =
    "Used for TFMSupervisor supervisor functionality including configuration and "
    "state "
    "transitions.";
const std::string                              authors = "Ryan Rivera, Lorenzo Uplegger, Eric Flumerfelt, and others";
