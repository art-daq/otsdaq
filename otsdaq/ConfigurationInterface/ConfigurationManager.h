...
class ConfigurationManager
{
  ...
  public:
	...
	static const std::set<std::string> fixedContextMemberNames_;  ///< list of context members (not including optiona context tables)
	...
	std::set<std::string>
	    contextMemberNames_, configurationMemberNames_;  ///< list of 'active' configuration members
