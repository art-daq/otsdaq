...
class XDAQContextTable : public TableBase
{
  public:
	...
	std::string getContextOfApplication(ConfigurationManager* configManager,
	...
	static ConfigurationTree getContextNode(const ConfigurationManager* configManager,
	                                        const std::string&          contextUID);
	static ConfigurationTree getApplicationNode(const ConfigurationManager* configManager,
	                                            const std::string&          contextUID,
	                                            const std::string&          appUID);
	static ConfigurationTree getSupervisorConfigNode(
  ...
  public:
	static const std::set<std::string> FETypeClassNames_, DMTypeClassNames_,
	    ...
	    CodeEditorTypeClassNames_, VisualizerTypeClassNames_, SlowControlsTypeClassNames_;
	...
	static const std::map<std::string /*class*/, std::string /*module*/>
