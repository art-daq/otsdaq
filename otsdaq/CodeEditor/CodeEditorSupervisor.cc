...
//==============================================================================
CodeEditorSupervisor::CodeEditorSupervisor(xdaq::ApplicationStub* stub)
                                   ...
                                   const WebUsers::RequestUserInfo& userInfo)
{
	...
	{
		__SUP_SS__ << "requestType Request, " << requestType << ", not recognized by the Code Editor Supervisor (was it intended for another Supervisor?)."
		           << __E__;
		__SUP_SS_THROW__;
	}
}  // end request()
